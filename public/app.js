...
{ name: 'Upavedas', subtitle: 'Four classical applied sciences', status: 'partial',
  parts: [{ name: 'Āyurveda', meta: 'Medicine', status: 'live', external: true, link: '/ayurveda.html' }, { name: 'Dhanurveda', meta: 'Warfare' }, { name: 'Gāndharvaveda', meta: 'Music & drama', status: 'live', external: true, link: '/gandharvaveda.html' }, { name: 'Sthāpatyaveda', meta: 'Architecture', status: 'live', external: true, link: '/sthapatyaveda.html' }] },
