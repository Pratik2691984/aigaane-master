...
def validate_semantic_layer(
    ...
    checks = {
        ...
        "semanticDerivationGraphValidationPasses": derivation_graph_summary.get("derivationGraphValidationStatus") == "PASS",
    }
    return {
        "schemaVersion": "1.0.0",
        ...
        "semanticDerivationGraphSummary": derivation_graph_summary,
        "checks": checks,
    }
